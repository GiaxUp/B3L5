...
public class Prestiti implements Serializable {
	...
	public Prestiti(Utente utente, Archivio archivio, LocalDate data_inizio_prestito,
	...
	public String toString() {
		return "Prestiti [ID: " + id + ", Utente: " + utente + ", Archivio: " + archivio + ", Data inizio prestito: "
				+ data_inizio_prestito + ", Data restituzione preveista: " + data_restituzione_prevista
				+ ", Data restituzione effettiva: " + data_restituzione_effettiva + "]";
	}
